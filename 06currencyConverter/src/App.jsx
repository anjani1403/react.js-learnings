  ...
  return (
    ...
    >
      <div className="w-full">
        <h1 className='w-full max-w-md mx-auto border border-black rounded-lg p-5 backdrop-blur-sm text-4xl font-bold text-center text-white mb-3 px-3'>Currency Converter</h1>
